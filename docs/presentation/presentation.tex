...
\begin{document}
	...
	\begin{frame}{Window Advancement Scheme}
		\begin{figure}
			\centering
			\begin{tikzpicture}[>=stealth',t/.style={minimum width=1cm, minimum height=0.7cm}]
				...
				\node[draw] at (0,1.5) {0};
				\node[draw,fill=red] at (4,0) {3};
				\node[draw,fill=red] at (4,0.5) {2};
				\node[draw] at (4,1) {1};
				\node[draw] at (4,1.5) {0};
				...
				\node[draw] at (4,3) {3};
				\node[draw] at (4,3.5) {2};
				\node[draw,fill=red] at (4,4) {1};
				\node[draw,fill=red] at (4,4.5) {0};
				\coordinate (r) at (3.8,1);
				\draw[->] (s) -- node[above] {coded packet} (s-|r);
				\node[] at (2,-0.5)  {B};
				...
				\node[draw,fill=red] at (6,4.5) {0};
				\node[draw] at (10,3) {3};
				\node[draw,fill=red] at (10,3.5) {2};
				\node[draw,fill=red] at (10,4) {1};
				\node[draw] at (10,4.5) {0};
				\coordinate (r) at (9.8,1);
				\draw[<-] (s) -- node[above] {acknowlegment} (s-|r);
				\node[] at (8,-0.5)  {D};
			\end{tikzpicture}
		\end{figure}
	\end{frame}
